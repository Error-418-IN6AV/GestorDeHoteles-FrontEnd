                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <Link to='/dashboard/event'>
                                <button onClick={addType} type="button" className="btn btn-primary" data-bs-dismiss="modal">ADD EVENT</button>
                            </Link>
                        </div>
                    </div>
                </div>
